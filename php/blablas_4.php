...
// C'est ce qui est fait dans la fonction hr_est_entier()
if (count($_GET) != 1 || ! isset($_GET['id']) || ! hr_est_entier(($_GET['id'])) || $_GET['id'] <= 0){
    hr_aff_entete('Erreur');
    hr_aff_infos();
    echo    '<ul>',
...
if ($t['blTexte'] == null){
    echo '<li>', hr_html_proteger_sortie($t['autPseudo']), ' n\'a pas publié de message</li>';
}
else{

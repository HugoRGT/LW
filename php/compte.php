...
function hrl_aff_account_settings(mysqli $bd):void{
    ...
    echo '<h2 class="titreAccountSettings">Informations personnelles</h2>',
        '<img src="../images/trait.png" alt="trait.png"/>';
    hr_aff_info_perso($bd,$errPerso);

    echo '<h2 class="titreAccountSettings">Informations sur votre compte Cuiteur</h2>',
        '<img src="../images/trait.png" alt="trait.png"/>';
    hr_aff_info_account($bd,$errAccount);

    echo '<h2 class="titreAccountSettings">Paramètres de votre compte Cuiteur</h2>',
        '<img src="../images/trait.png" alt="trait.png"/>';
